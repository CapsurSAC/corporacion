    ...
    return (
        <div className="flex items-center justify-between border-b p-4 last:border-b-0">
            ...
            <Dialog>
                ...
                <DialogContent>
                    <DialogTitle>Remover clave de acceso</DialogTitle>
                    <DialogDescription>
                        ¿Estás seguro de que deseas remover la clave "{passkey.name}"?
                        Ya no podrás utilizarla para acceder al catálogo.
                    </DialogDescription>
                    <DialogFooter className="gap-2">
                        ...
                        <Button
                            ...
                            disabled={isDeleting}
                        >
                            {isDeleting ? 'Removiendo...' : 'Remover clave'}
                        </Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
