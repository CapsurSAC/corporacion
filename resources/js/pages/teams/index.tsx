...
export default function TeamsIndex({ teams }: Props) {
    ...
    return (
        <>
            <Head title="Equipos y Sedes" />

            <h1 className="sr-only">Equipos y Sedes</h1>

            <div className="flex flex-col space-y-6">
                <div className="flex items-center justify-between">
                    <Heading
                        variant="small"
                        title="Equipos y Sedes"
                        description="Administra tus equipos de trabajo y membresías institucionales"
                    />
