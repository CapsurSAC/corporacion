                                ...
                                {filteredCarreras.map((c) => (
                                    <MenuItem key={c.id} value={String(c.id)}>
                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, minWidth: 0, overflow: 'hidden' }}>
                                            <SchoolIcon sx={{ fontSize: '1rem', color: c.comercio?.color_hex || 'primary.main', flexShrink: 0 }} />
                                ...
                                {rubros.map((r) => (
                                    <MenuItem key={r.id} value={String(r.id)}>
                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, minWidth: 0, overflow: 'hidden' }}>
                                            ...
                                            <Typography variant="body2" noWrap sx={{ overflow: 'hidden', textOverflow: 'ellipsis' }}>{r.nombre}</Typography>
                                        </Box>
                                    </MenuItem>
                                ))}
                            </Select>
